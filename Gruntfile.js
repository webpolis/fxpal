...
module.exports = function(grunt) {
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    cwd: '<%= yeoman.app %>',
                    dest: '<%= yeoman.dist %>',
                    src: ['*.{ico,png,txt}', '.htaccess', '*.html', 'views/{,*/}*.html', 'images/{,*/}*.{webp}', 'fonts/*', 'config.xml', 'res/**/*.*', 'data/**/*.*', '!data/**/Calendar*.csv', '!data/**/*.xml', '!data/multisetsOutputsRaw.csv', '!data/multisetsInputs.csv']
                }, {
                    expand: true,
                    cwd: '.tmp/images',
                    dest: '<%= yeoman.dist %>/images',
    ...
    grunt.registerTask('build', ['clean:dist', 'wiredep', 'useminPrepare', 'concurrent:dist', 'autoprefixer', 'concat', 'ngmin', 'copy:dist', 'cdnify', 'cssmin', 'uglify', 'filerev', 'usemin', 'htmlmin']);
