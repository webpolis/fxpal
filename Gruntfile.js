    ...
    grunt.initConfig({
        ...
        wiredep: {
            app: {
                ...
                ignorePath: /\.\.\//,
                exclude: ['bower_components/regression-js/index.js']
            }
        },
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    cwd: '<%= yeoman.app %>',
                    dest: '<%= yeoman.dist %>',
                    src: ['*.{ico,png,txt}', '.htaccess', '*.html', 'views/{,*/}*.html', 'images/**/*.{png,jpg,jpeg,gif}', 'fonts/*', 'config.xml', 'res/**/*.*', 'scripts/analytics.js']
                }, {
                    expand: true,
                    cwd: '.tmp/images',
                    dest: '<%= yeoman.dist %>/images',
