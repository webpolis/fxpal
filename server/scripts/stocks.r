...
stocks = strsplit("FME.DE,RB.L,ABF.L,RRS.L,BAB.L,TT.L,LMT,NG.L,IMT.L,GSK.L,CPI.L,SHP.L,CHKP,SSE.L,MT.PA,TATE.L,NFLX,CNA.L,BIDU,MRW.L,BATS.L,FRE.DE,ULVR.L,AMGN,TWTR", ",")[[1]]
