...
angular.module('aifxApp').controller('appController', function($scope, $ionicSideMenuDelegate, $rootScope) {
    ...
    $scope.config = {
        ...
        urls: {
            ...
            events: 'http://calendar.fxstreet.com/eventdate/mini?f=json&culture=en-US&rows=100&pastevents=100&hoursbefore=160&timezone=Argentina+Standard+Time&columns=date%2Ctime%2Cevent%2Cconsensus%2Cprevious%2Cactual&showcountryname=false&countrycode=AU%2CCA%2CJP%3AEMU%2CNZ%2CCH%2CUK%2CUS&isfree=true'
        },
